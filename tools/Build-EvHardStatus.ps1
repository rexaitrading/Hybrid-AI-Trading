...
$outPath = Join-Path $logsDir "ev_hard_status.json"

# FAIL-CLOSED default: ok_today=false until real EV-hard snapshot runs and writes evidence
$obj = [ordered]@{
...
Write-Host ("[EV-HARD] wrote " + $outPath + " ok_today=false reason=stub_not_implemented") -ForegroundColor Yellow
