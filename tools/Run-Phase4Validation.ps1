...
# 1) Phase-1 replay demo (NVDA bar replay ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ EV summary)
Invoke-Phase4PyTest -Label "Phase-1 replay demo pytest" -Args @(
    "tests/test_phase1_replay_demo.py"
)

# 2) Microstructure features (SPY/QQQ microstructure core) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ optional until tests exist
...
) | Where-Object { Test-Path (Join-Path $repoRoot [CmdletBinding()]
param()
