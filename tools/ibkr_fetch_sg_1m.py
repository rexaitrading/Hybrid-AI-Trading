...
def bar_date_to_tokyo_yyyymmdd(s: str) -> str:
    ...
    if raw.isdigit():
        ...
        return dt.astimezone(ZoneInfo("Asia/Singapore")).strftime("%Y%m%d")
...
def ymd_to_ib_end(ymd: str, hhmm: str) -> str:
    ...
    dt_tokyo = _dt.datetime(y, m, dd, hh, mm, 0, tzinfo=ZoneInfo("Asia/Singapore"))
...
def main():
    ...
    windows = [("17:00", "RTH")]  # SG window; single end time
    any_fail = False
    any_mismatch = False
