function Get-EvBandSamplesOkTodayForSymbol {
    ...
    $row = $rows | Where-Object {
        ...
        ((if (function Get-EvBandSamplesOkTodayForSymbol {
    param(
        [Parameter(Mandatory = $true)][string]$Symbol,
        [Parameter()][int]$MinTrades = 3
    )
...
.PSObject.Properties.Name -contains "date") { function Get-EvBandSamplesOkTodayForSymbol {
    param(
        [Parameter(Mandatory = $true)][string]$Symbol,
        [Parameter()][int]$MinTrades = 3
    )
...
.date } elseif (function Get-EvBandSamplesOkTodayForSymbol {
    param(
        [Parameter(Mandatory = $true)][string]$Symbol,
        [Parameter()][int]$MinTrades = 3
    )
...
.PSObject.Properties.Name -contains "as_of_date") { function Get-EvBandSamplesOkTodayForSymbol {
    param(
        [Parameter(Mandatory = $true)][string]$Symbol,
        [Parameter()][int]$MinTrades = 3
    )
...
.as_of_date } elseif (function Get-EvBandSamplesOkTodayForSymbol {
    param(
        [Parameter(Mandatory = $true)][string]$Symbol,
        [Parameter()][int]$MinTrades = 3
    )
...
.PSObject.Properties.Name -contains "ts_utc") { function Get-EvBandSamplesOkTodayForSymbol {
    param(
        [Parameter(Mandatory = $true)][string]$Symbol,
        [Parameter()][int]$MinTrades = 3
    )
