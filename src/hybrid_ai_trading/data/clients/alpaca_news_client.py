...
class AlpacaNewsClient:
    def __init__(self, key_id: Optional[str]=None, secret_key: Optional[str]=None, base_url="https://data.alpaca.markets"):
    ...
    def get_news(self, symbols_csv: str, limit: int=10, date_from: Optional[str]=None) -> List[Dict[str, Any]]:
        ...
        for it in data.get("news", []):
            ...
            out.append({
                "id": it.get("id"), "author": it.get("author", ""),
                ...
                "body": "", "url": it.get("url") or "",
                "image": [], "channels": [], "stocks": stocks, "tags": [], "source": "alpaca"
            })
        return out
