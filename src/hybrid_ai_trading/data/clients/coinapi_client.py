...
"""
CoinAPI Client (Hybrid AI Quant Pro v1.4 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ Hedge-Fund OE Grade, Test-Friendly)
-------------------------------------------------------------------------------
Exports:
...
def _get_headers() -> Dict[str, str]:
    ...
    Rules per tests:
    - If COINAPI_STUB=1 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ return {}
    - load_config() may raise ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ raise CoinAPIError
    - invalid/None config ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ raise CoinAPIError
    - config.providers.coinapi.api_key_env missing/None ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ raise CoinAPIError
    - env var missing or empty:
        - if COINAPI_ALLOW_STUB != "0" ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ return {}
        - else raise CoinAPIError
    - happy path ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ {"X-CoinAPI-Key": <env>}
    """
...
def _retry_get(
    ...
    *,
    ...
    Stub path: if headers == {} and COINAPI_ALLOW_STUB!= "0" ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ return _StubResponse().
    """
    ...
    *,
    ...
    try:
        resp = sess.get(
            url,
            headers=(
                _get_headers() or {"X-CoinAPI-Key": api_key}
                if api_key
                else _get_headers()
            ),
            params=params or {},
...
def batch_prev_close(
    ...
    *,
    ...
    - STUB: if COINAPI_STUB=1 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ status 'STUB' w/ synthetic bar
