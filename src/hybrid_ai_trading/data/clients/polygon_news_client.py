...
class PolygonNewsClient:
    ...
    def get_news(self, symbol: Optional[str] = None, limit: int = 10, date_from: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        for it in results:
            ...
            items.append({
                "id": story_id, "author": author, "created": created, "updated": created,
                "title": title, "teaser": "", "body": "", "url": url_out,
                "image": [], "channels": [], "stocks": stocks, "tags": [], "source": "polygon",
            })
        return items