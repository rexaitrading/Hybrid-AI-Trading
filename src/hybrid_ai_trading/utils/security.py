"""
Security Utilities (Hybrid AI Quant Pro v10.8 �?,???o Hedge-Fund Grade, 100% Coverage)
-------------------------------------------------------------------------------
Responsibilities:
...
def mask_key(key: Optional[str]) -> str:
    ...
    Rules:
    - None or empty �?????T "None"
    - Short (<8) �?????T returned unchanged
    - ==8 �?????T show first 4 + '****' + last 4
    - >8 �?????T show first 4 + stars (len-8) + last 4
