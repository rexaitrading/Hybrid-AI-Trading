"""
Portfolio Tracker (Hybrid AI Quant Pro v91.4 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ Hedge-Fund OE Grade, Polished)
-------------------------------------------------------------------------------
...
class PortfolioTracker:
    ...
    def __init__(self, starting_equity: float = 100000.0, base_currency: str = "USD"):
        ...
        logger.debug(
            "ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ PortfolioTracker initialized | Equity=%.2f %s",
            self.equity,
            self.base_currency,
        )
    ...
    def get_var(self, alpha: float = 0.95) -> float:
        ...
        if len(rets) < 2:
            ...
            )  # ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ aligned with tests
            return 0.0
        try:
