...
def _qc_run_once(symbols, snapshots, cfg, logger) -> Dict[str, Any]:
...
def _cli_main():
    try:
        ...
        parser.add_argument(
            "--log-file", type=str, default="logs/runner_paper.jsonl"
        )
