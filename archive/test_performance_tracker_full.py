"""
Unit Tests: PerformanceTracker (Hybrid AI Quant Pro v7.4 – AAA+ Coverage, Fixed)
-------------------------------------------------------------------------------
Covers ALL branches and uncovered lines in performance_tracker.py:
- recorders (trade/equity/benchmark)
- win_rate/payoff/roi
- sharpe + sortino (valid, zero, exception, downside=0, no trades)
- calmar, omega
- alpha_beta (too few, valid, exception)
