...
risk = RiskManager(RiskConfig(per_trade_notional_cap=50.0, max_trades_per_day=1))
...
# Inject keys into the Kraken broker (runnerÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s factory creates a plain client)
