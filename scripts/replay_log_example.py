...
log_trade(
    path=csv_out,
    Date=date, Ticker=ticker, Setup=setup, Context=context,
    EntryTime=entry_t, ExitTime=exit_t,
    Entry=entry, Exit=exit_, Qty=qty, Fees=fees, Slippage=slip,
    RM=rm, PnL=pnl, Notes=notes, ReplayID=replay_id
)
print("Wrote", csv_out)