...
if __name__ == "__main__":
    ...
    def test_kraken():
        ...
        assets = [k for k, v in (bal.get("total") or {}).items() if v] or list(
            (bal.get("total") or {}).keys()
        )[:5]
    ...
    notes = []
    if any(r.get("warn") == "ibkr_fallback" for r in results):
