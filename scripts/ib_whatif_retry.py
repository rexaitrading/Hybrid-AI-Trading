...
SENTINEL = 1.79e308
def bad(v): return (v is None) or (isinstance(v, float) and v > 1e300)
...
o = LimitOrder("BUY", 1, round(px,2)); o.account = acct; o.tif="DAY"

best = None
for _ in range(4):
    st = ib.whatIfOrder(c, o)
    vals = (getattr(st,'initMarginChange',None),
