import os, json, importlib, types, pytest
...
def test_force_close_branch(monkeypatch):
    ...
    # create BUY pos
    pos={"side":"BUY","qty":1.0,"avg_px":100.0,"opened_bar_ts":ts-3600_000,"peak":101.0}
...
def test_opposite_exit_for_sell(monkeypatch):
    ...
    pos={"side":"SELL","qty":1.0,"avg_px":100.0,"opened_bar_ts":ts-3600_000,"trough":99.0}
    json.dump(pos, open(r.pos_path,"w",encoding="utf-8"))
