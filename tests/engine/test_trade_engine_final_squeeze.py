...
class _Stub:
    ...
    def place_order(self, symbol, side, qty, order_type="MARKET", limit_price=None, meta=None):
        return 11, {"status":"Filled","filled":float(qty or 0),"avgPrice":float(limit_price or 0.0),"meta":meta or {}}
...
def test_late_helpers_weird_inputs(eng):
    ...
    events = [
        ...
        {"symbol":"AAPL","signal":"SELL","price":101.0,"size":2,"signal":"SELL"},  # duplicate key (same)
        {},                                                                         # empty
        123,                                                                         # non-dict
    ]
