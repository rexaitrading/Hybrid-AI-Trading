import types, time, pytest
from hybrid_ai_trading.broker.ib_safe import (
    retry, connect_ib, account_snapshot, cancel_all_open, force_refresh_positions,
    marketable_limit, map_ib_error
)
...
class IBStubValues:
    ...
    def waitOnUpdate(self, timeout=1.0): time.sleep(0) or True
