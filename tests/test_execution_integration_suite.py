"""
Integration Suite: Execution + Trade Engine (Hybrid AI Quant Pro v10.8 Ã¢â‚¬â€œ Final AAA Polished)
-------------------------------------------------------------------------------------------
Covers:
...
def test_sentiment_and_gatescore_exceptions(base_config, portfolio, monkeypatch):
    # Ã¢Å“â€¦ Ensure regime is enabled so sentiment/gatescore branches are actually evaluated
