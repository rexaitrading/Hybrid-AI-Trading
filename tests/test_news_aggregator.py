...
def _temp_config(tmp_path):
    ...
    cfg = {
        "news_providers": {
            ...
            "rss":      {"enabled": True,  "per_feed_max": 3,
                         "google_template": None, "yahoo_template": None, "extra_feeds": []},
        }
    }
...
class _DummyBZ:
    def get_news(self, symbols_csv, limit=10, date_from=None):
        ...
        return [
            {"id":"bz1","author":"bz","created":"2025-10-01","title":"AAPL beats estimates","url":"https://example.com/s1",
             "stocks":[{"name":"AAPL","exchange":""}]},
            {"id":"bz_dup","author":"bz","created":"2025-10-01","title":"META update","url":"https://dup.example.com",
...
class _DummyPG:
    def get_news(self, symbol, limit=5, date_from=None):
        ...
        if symbol == "META":
            return [{"id":"pg_meta","author":"pg","created":"2025-10-01","title":"META update",
                     "url":"https://dup.example.com","stocks":[{"name":"META","exchange":""}]}]
        elif symbol == "TSLA":
            return [{"id":"pg_tsla","author":"pg","created":"2025-10-01","title":"TSLA recall",
                     "url":"https://example.com/s2","stocks":[]}]
        else:
            return []
...
class _DummyAP:
    def get_news(self, symbols_csv, limit=10, date_from=None):
        ...
        return [{"id":"ap_aapl","author":"ap","created":"2025-10-01","title":"AAPL approval",
                 "url":"https://example.com/s3","stocks":[{"name":"AAPL","exchange":""}]}]

class _DummyRSS:
    def __init__(self, *a, **k): pass
    def get_news(self, symbols_csv, date_from=None):
        # One RSS generic headline that still tags AAPL
        return [{"id":"rss_aapl","author":"rss","created":"2025-10-01","title":"Record profit at Apple",
                 "url":"https://example.com/s4","stocks":[{"name":"AAPL","exchange":""}]}]
