...
def test_drawdown_try_except_and_hedge(monkeypatch):
    ...
    assert r["status"] == "blocked" and r["reason"] in {"hedge_rule","sector_exposure","drawdown_breach","equity_depleted","sentiment_veto","gatescore_veto","sharpe_breach","sortino_breach","router_failed","router_error","invalid_status"}
