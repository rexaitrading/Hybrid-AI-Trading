...
# ---- reset_day: combined error and generic except (175Ã¢â‚¬â€œ198, 192) ----
def test_reset_day_combined_and_generic(monkeypatch):
    ...
    class BadPortfolio(type(te2.portfolio)):
        def reset_day(
            self,
        ):  # method still present; weÃ¢â‚¬â„¢ll blow up by removing attribute mid-call
...
# ---- drawdown try/except (241Ã¢â‚¬â€œ251 esp. 247Ã¢â‚¬â€œ248) + hedge check (240) ----
...
# ---- algo lines coverage: iceberg path & residual lines (256Ã¢â‚¬â€œ257, 269, 273Ã¢â‚¬â€œ274) ----
...
# ---- invalid_status normalization guard (332) & log capture (351Ã¢â‚¬â€œ352) ----
def test_invalid_status_and_audit_capture(monkeypatch):
    ...
    # Invalid status from router â†’ must normalize to rejected/invalid_status
