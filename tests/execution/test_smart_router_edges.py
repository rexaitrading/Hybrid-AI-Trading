...
# 59Ã¢â‚¬â€œ60: rank_brokers() dict-comp + sort
...
# 97Ã¢â‚¬â€œ98: if not client: continue
...
# 142Ã¢â‚¬â€œ146: ok->filled AND pending return lines
...
# 154Ã¢â‚¬â€œ156: blocked and rejected both break inner loop; router must continue to next broker
