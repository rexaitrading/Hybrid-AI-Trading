...
"""
Unit Tests: ExecutionEngine (Hybrid AI Quant Pro v15.7 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ Hedge Fund Grade, 100% Coverage)
-----------------------------------------------------------------------------------------
...
def config_stub(tmp_path):
    ...
    return {
        ...
        "risk": {
            "equity": 50_000.0,  # ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ regression guard for equity kwarg
            "max_drawdown": 0.2,
