"""
Unit Tests: Security Utilities (Hybrid AI Quant Pro v11.2 Ã¢â‚¬â€œ Hedge-Fund Grade, 100% Coverage)
============================================================================================
...
def test_mask_key_minimal_long_case():
    """Check smallest >8 case (9 chars) Ã¢â€ â€™ 1 star in the middle."""
    key = "ABCDEFGHI"
    result = mask_key(key)
...
def test_mask_key_boundary_cases():
    ...
    key7 = "1234567"  # 7 chars Ã¢â€ â€™ unchanged
    assert mask_key(key7) == key7

    key8 = "12345678"  # 8 chars Ã¢â€ â€™ formatted
    assert mask_key(key8) == "1234****5678"

    key9 = "123456789"  # 9 chars Ã¢â€ â€™ 1 star
