...
from hybrid_ai_trading.data.clients.polygon_news_client import PolygonNewsClient, PolygonAPIError
...
def test_no_key_raises(monkeypatch):
    # clear keys
    os.environ.pop("POLYGON_KEY", None); os.environ.pop("POLYGON_API_KEY", None)
...
def test_list_payload_and_empty_tickers(monkeypatch):
    ...
    data = [
        {"id":"a","published_utc":"2025-10-01T00:00:00Z","title":"No tickers","url":"https://x/a","tickers":[]},
        {"id":"b","published_utc":"2025-10-01T01:00:00Z","title":"Str ticker","url":"https://x/b","tickers":"MSFT"},
    ]
