...
def test_get_prices_list_bad_data_logs_and_returns_empty(caplog):
    """Covers _get_prices(list) exception branch (bad price coercion) Ã¢â€ â€™ empty Series."""
...
def test_detect_stats_exception_again_hits_94_96(monkeypatch, caplog):
    """Force std() to raise a distinct exception while mean() works, to hit error/return lines 94Ã¢â‚¬â€œ96."""
    import pandas as pd
